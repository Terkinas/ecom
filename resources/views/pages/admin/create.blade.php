            ...
            <article class="bg-white rounded shadow-sm border border-gray-200 p-4 lg:p-6 my-5">
                ...
                <form action="{{ route('admin.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            <select name="category" class="block appearance-none border border-gray-200 bg-gray-100 rounded-md py-2 px-3 hover:border-gray-400 focus:outline-none focus:border-gray-400 w-full">
                    ...
                    <div class="grid md:grid-cols-2 gap-x-2">
                        ...
                        <!-- <div class="mb-4">
                            <label class="block mb-1"> Išparduoti </label>
                            <div class="relative">
                                <select name="onsale" class="block appearance-none border border-gray-200 bg-gray-100 rounded-md py-2 px-3 hover:border-gray-400 focus:outline-none focus:border-gray-400 w-full">
                    ...
                    <!-- <div class="mb-4">
                        <label class="block mb-1"> Siuntimo kaina </label>
                        <div class="grid grid-cols-3 gap-x-2 md:w-1/2">
                            <div class="col-span-2">
                                <input name="shipping_fee" type="text" class="appearance-none border border-gray-200 bg-gray-100 rounded-md py-2 px-3 hover:border-gray-400 focus:outline-none focus:border-gray-400 w-full" placeholder="0.00" />
                            </div>
                            <div>
                                <select disabled class="block appearance-none border border-gray-200 bg-gray-100 rounded-md py-2 px-3 hover:border-gray-400 focus:outline-none focus:border-gray-400 w-full" placeholder="Select one option">
                                    <option> EUR </option>
